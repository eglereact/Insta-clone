...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    //upload an image to firestore with post ID
    //get download url from fb and update the original post
    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div className="flex min-h-[800px] items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:min-h-screen sm:p-0">
          ...
          >
            <div
              className="inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left
